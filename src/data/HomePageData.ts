const heroSectionData = {
  title1: "MADRAS FILM CLUB",
  title2: "FILM FESTIVAL",
  title3: "2023",
  title4: "Vanakkam",
  description:
    "Most Popular Film Festival in South India, gathering film talents from all over the World. 20 films are to be screened during the week-long festival.",
  date: "14.11.2023(MON) ~ 20(SUN)",
